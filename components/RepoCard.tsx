    ...
    <Box sx={{p: 2, border: 1, borderRadius: '1%', display: 'flex', flexDirection: 'column'}}>
      <Box sx={{display: 'flex', alignItems: 'center', marginBottom: 1.5}}>
        <Box sx={{marginRight: '5%'}}>
          <Typography variant='h6' component='h3' sx={{color: '#0969DA', textDecoration: 'underline'}}>
            {repoData.name}
          </Typography>
        </Box>
      ...
      <Box sx={ notMobile ? {display: 'flex', marginBottom: 1.5, gap: 0.75, fontStyle: 'italic'} : {display: 'flex', flexDirection: 'column', marginBottom: 1.5, fontStyle: 'italic'}}>
        <Box>
        ...
        <Box>
          <Link href={repoData.html_url}>
            <a>
              <Typography sx={{color: '#0000EE', textDecoration: 'underline', fontSize: 16, overflowWrap: 'anywhere'}}>
                {repoData.html_url}
              </Typography>
            </a>
          </Link>
      ...
      <Box sx={{display: 'flex', alignItems: 'center', color: '#57606A'}}>
        <Box sx={{marginRight: 1}}>
          <Image src={'/blue-dot.png'} width={12} height={12} />
        </Box>
